 ...
 */
public class UpdateableMultilayerPerceptron 
  extends AbstractClassifier 
  implements OptionHandler, WeightedInstancesHandler, Randomizable, UpdateableClassifier {
  ...
  public static void main(String [] argv) {
    runClassifier(new UpdateableMultilayerPerceptron(), argv);
  }
   ...
   * The constructor.
   */
  public UpdateableMultilayerPerceptron() {
    m_instances = null;
